...
namespace BugTracker
{
    public partial class frmDetalleBug : Form
    {
        ...
        internal void InicializarDetalleBug(int idBug)
        {
            ...
            this.txtCriticidad.Text = dtBug.Rows[0]["criticidad"].ToString();
            this.txtDescripcion.Text = dtBug.Rows[0]["descripcion"].ToString();
            this.txtEstado.Text = dtBug.Rows[0]["estado"].ToString();
            this.txtFechaAlta.Text = dtBug.Rows[0]["fecha_alta"].ToString();
            this.txtNroBug.Text = dtBug.Rows[0]["id_bug"].ToString();
            this.txtPrioridad.Text = dtBug.Rows[0]["prioridad"].ToString();
            this.txtProducto.Text = dtBug.Rows[0]["producto"].ToString();
            this.txtTitulo.Text = dtBug.Rows[0]["titulo"].ToString();
